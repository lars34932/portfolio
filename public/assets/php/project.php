...
function makeCards() {
    ...
    foreach ($projects as $project) {
        ...
        echo '  </ul>
                ...
                <a class="card__link" href="projectPage.php?name=' . $project['buttonLink'] . '"><button class="project__button">Project 1 <i class="fa-solid fa-arrow-up fa-rotate-by" style="--fa-rotate-angle: 45deg;"></i></button></a>
            </li>';
    }
}
